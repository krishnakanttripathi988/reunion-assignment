...
urlpatterns = [
    ...
    path('api/unfollow/<id>',UnFollow.as_view()),
    path('api/user',GetUser.as_view()),
    path('api/posts',UploadPost.as_view()),
    path('api/posts/<id>',DeletePost.as_view()),
    path('api/like/<id>',LikePost.as_view()),
    path('api/unlike/<id>',UnLikePost.as_view()),
    path('api/comment/<id>',CommentPost.as_view()),
